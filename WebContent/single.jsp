			...
			<div class="col-md-9 top-in-single">
				...
				<div class="col-md-7 single-top-in">
					<div class="single-para">
						...
						<div class="para-grid">
						<input type="hidden" name="pid" value="${list[0]}"/>
						<input type="hidden" name="price" value="${list[2]"/>
						<input type="hidden" name="pname" value="${list[1]"/>
						
							<span class="add-to">$${list[2]}</span> <a href="/cart/addCart.action"class="hvr-shutter-in-vertical cart-to">添加到购物车</a>
						...
						<div class="available">
							...
							<ul>
								<li>Color: <select name="color">
										<c:forEach items="${list[3]}" var="colors">
											<option>${colors}</option>
										</c:forEach>
								</select></li>
								<li>Size:<select name="size">
										<c:forEach items="${list[4]}" var="size">
											<option>${size}</option>
										</c:forEach>
								</select></li>
								<li>Quality:<select name="quality">
										<c:forEach items="${list[5]}"  var="quality">
					...
					<div class="col-md-4 top-single-in">
						<div class="col-md">
							...
							<div class="top-content">
								...
								<div class="white">
									<a href="#"
										class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">添加到购物车
										</a>
									<p class="dollar">
										<span class="in-dollar">$</span><span>2</span><span>0</span>
									</p>
