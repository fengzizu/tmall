			...
			<div class="products">
				...
				<c:forEach items="${productlist }" var="product">
					...
					<div class="col-md-3 md-col">
						<div class="col-md">
							<a href="${pageContext.request.contextPath}/LookProductDetail?pid=${product.pid}" class="compare-in"><img
									src="${product.pimage }" alt="" />
								<div class="compare">
							...
							<div class="top-content">
								<h5>
									<a href="single.html">${product.pname }</a>
								</h5>
								<div class="white">
									<a href="single.html"
					...
					<!--  <div class="col-md-3 md-col">
						<div class="col-md">
							...
							<div class="top-content">
								<h5>
									<a href="single.html">Simply random</a>
								</h5>
								<div class="white">
									<a href="single.html"
										class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD
							...
							<div class="top-content">
								...
								<div class="white">
									<a href="single.html"
										...
										TO CART</a>
									<p class="dollar">
										<span class="in-dollar">$</span><span>1</span><span>5</span>
									</p>
									<div class="clearfix"></div>
								</div>
							</div>
					...
					<div class="col-md-3 md-col">
						<div class="col-md">
							...
							<div class="top-content">
								<h5>
									<a href="single.html">Standard chunk</a>
								</h5>
								<div class="white">
									<a href="single.html"
										class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD
				...
				<!--<div class=" top-products">
					...
					<div class="col-md-3 md-col">
						<div class="col-md">
							...
							<div class="top-content">
								<h5>
									<a href="single.html">Popular belief</a>
								</h5>
								<div class="white">
									<a href="single.html"
										class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD
										TO CART</a>
									<p class="dollar">
										<span class="in-dollar">$</span><span>5</span><span>5</span>
									</p>
									<div class="clearfix"></div>
								</div>
							</div>
							...
							<div class="top-content">
								...
								<div class="white">
									<a href="single.html"
										...
										TO CART</a>
									<p class="dollar">
										<span class="in-dollar">$</span><span>2</span><span>9</span>
									</p>
									<div class="clearfix"></div>
								</div>
							</div>
